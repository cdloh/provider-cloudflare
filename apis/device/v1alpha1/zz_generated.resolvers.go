...
// ResolveReferences of this DexText.
func (mg *DexText) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this ManagedNetwork.
func (mg *ManagedNetwork) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
