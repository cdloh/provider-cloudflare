...
// GetInitParameters of this Override
func (tr *Override) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Override
func (tr *Override) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
