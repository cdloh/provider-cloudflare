...
// GetInitParameters of this Bookmark
func (tr *Bookmark) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Bookmark
func (tr *Bookmark) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
