...
// GetInitParameters of this IPList
func (tr *IPList) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IPList
func (tr *IPList) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
